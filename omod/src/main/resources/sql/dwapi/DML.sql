...
CREATE PROCEDURE sp_populate_dwapi_prep_monthly_refill()
  BEGIN
    ...
    select
           ...
           max(if(o.concept_id = 164515, (case o.value_coded when 161364 then "TDF/3TC" when 84795 then "TDF" when 104567 then "TDF/FTC" when 168050 then "CAB-LA" when 168049 then "Dapivirine Ring"  else "" end), "" )) as prescribed_regimen,
    ...
    select
      ...
      (case f.uuid
       ...
       if(max(o.date_created) > min(e.date_created),max(o.date_created),NULL) as date_last_modified,
        ...
        max(if(o.concept_id = 164515, (case o.value_coded when 161364 then "TDF/3TC" when 84795 then "TDF" when 104567 then "TDF/FTC" when 168050 then "CAB-LA" when 168049 then "Dapivirine Ring" end), "" )) as regimen_prescribed,
...
DROP PROCEDURE IF EXISTS sp_populate_dwapi_etl_mat_clinical_encounter $$
CREATE PROCEDURE sp_populate_dwapi_etl_mat_clinical_encounter()
BEGIN
    SELECT "Processing MAT clinical encounter data... ";
    insert into dwapi_etl.etl_mat_clinical_encounter(
        uuid,
        encounter_provider,
        patient_id,
        visit_id,
...
DROP PROCEDURE IF EXISTS sp_populate_dwapi_etl_mat_transit $$
CREATE PROCEDURE sp_populate_dwapi_etl_mat_transit()
BEGIN
    SELECT "Processing MAT transit data... ";
    insert into dwapi_etl.etl_mat_transit(
        uuid,
        encounter_provider,
        patient_id,
        visit_id,
...
DROP PROCEDURE IF EXISTS sp_populate_dwapi_etl_mat_psychosocial_intake_and_followup $$
CREATE PROCEDURE sp_populate_dwapi_etl_mat_psychosocial_intake_and_followup()
BEGIN
    SELECT "Processing MAT psychosocial intake and followup... ";
    insert into dwapi_etl.etl_mat_psychosocial_intake_and_followup(
        uuid,
        encounter_provider,
        patient_id,
        visit_id,
...
DROP PROCEDURE IF EXISTS sp_populate_dwapi_etl_mat_cessation $$
CREATE PROCEDURE sp_populate_dwapi_etl_mat_cessation()
BEGIN
    SELECT "Processing MAT cessation data... ";
    insert into dwapi_etl.etl_mat_cessation(
        uuid,
        encounter_provider,
        patient_id,
        visit_id,
...
CALL sp_populate_dwapi_etl_mat_intial_registrations();
CALL sp_populate_dwapi_etl_mat_clinical_encounter();
