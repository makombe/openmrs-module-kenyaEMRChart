...
DROP TABLE IF EXISTS kenyaemr_etl.etl_mat_intial_registrations;
DROP TABLE IF EXISTS kenyaemr_etl.etl_mat_clinical_encounter;
...
(
    ...
    provider                                  INT(11)  NOT NULL,
    visit_date                                DATE,
    entry_point_at_enrolment                  VARCHAR(50),
    other_entry_point_specify                 VARCHAR(255),
    who_brought_child_clinic                  VARCHAR(255),
    who_else_lives_child_household            VARCHAR(255),
    gives_child_medication                    VARCHAR(255),
    knows_child_hiv_status                    VARCHAR(255),
    other_house_member_has_hiv                VARCHAR(255),
    family_member_taking_arvs                 VARCHAR(255),
    discussed_informing_child_hiv_status      VARCHAR(255),
    discussion_outcome                        VARCHAR(255),
    child_told_why_come_clinic_or_medication  VARCHAR(255),
    questions_child_asking                    VARCHAR(255),
    care_giver_answer                         VARCHAR(255),
    child_ever_talk_about_hiv                 VARCHAR(255),
    what_does_child_say                       VARCHAR(255),
    child_doing_in_school                     VARCHAR(255),
    child_school_performance                  VARCHAR(255),
    child_like_school                         VARCHAR(255),
    child_have_friends                        VARCHAR(255),
    child_behaviour_home                      VARCHAR(255),
    worries_learning_hiv_status               VARCHAR(255),
    disclosure_preference                     VARCHAR(255),
    when_child_be_disclosed_to                VARCHAR(255),
    child_reactions_when_inform_status        VARCHAR(255),
    questions_caregiver_have_about_hiv        VARCHAR(500),   
    other_relative_who_brought_child_clinic VARCHAR(255),
    other_non_relative_who_brought_child_clinic VARCHAR(255),
    other_relative_lives_child_household VARCHAR(255),
    other_non_relative_lives_child_household VARCHAR(255),
    other_relative_gives_child_medication VARCHAR(255),
    other_non_relative_gives_child_medication VARCHAR(255),
    who_brings_child_clinic VARCHAR(255),
    other_relative_who_brings_child_clinic VARCHAR(255),
    other_non_relative_who_brings_child_clinic VARCHAR(255),
    other_relative_knows_child_hiv_status VARCHAR(255),
    other_non_relative_knows_child_hiv_status VARCHAR(255),
    other_reason_child_taking_medicaiton VARCHAR(255),
    other_reason_caregiver_thinks_reason_taking_medicaiton VARCHAR(255),
    other_questions_child_asking VARCHAR(255),
    other_care_giver_answer VARCHAR(255),
    other_worries_learning_hiv_status  VARCHAR(255),
    other_when_child_be_disclosed_to VARCHAR(255),
    cadre VARCHAR(255),
...
(
    ...
    self_management                           VARCHAR(100),
    communication                             VARCHAR(100),
    support                                   VARCHAR(100),
    adult_clinic_expectations                 VARCHAR(100),
    is_date_of_disclosure_known               VARCHAR(50),
    date_of_full_disclosure_not_known_specify VARCHAR(255),
    point_of_entry_at_enrollment                  VARCHAR(100),
    other_point_of_entry_at_enrollment VARCHAR(255),
    treatment_literacy_discussed  VARCHAR(255),
    self_management_discussed  VARCHAR(255),
    communication_discussed VARCHAR(255),
    support_discussed VARCHAR(255),
    cadre VARCHAR(255),
    department VARCHAR(255),
    date_created                      DATETIME NOT NULL,
    date_last_modified                DATETIME,
...
(
    ...
    provider                                  INT(11)  NOT NULL,
    visit_date                                DATE,   
    can_explain_hiv_is                        VARCHAR(50),
    explain_how_arv_work                      VARCHAR(50),
    knows_name_of_arv                         VARCHAR(50),
    explain_what_means_suppressed_vl          VARCHAR(50),
    state_what_thier_vl_is                    VARCHAR(50),
    knows_they_virally_suppressed             VARCHAR(50),
    know_day_date_of_current_clinic_visit     VARCHAR(50),
    came_on_scheduled                         VARCHAR(50),
    explain_what_to_do_missed_medication      VARCHAR(50),
    explain_where_to_seek_medical_care        VARCHAR(50),
    navigate_clinic_services_on_own           VARCHAR(50),
    comfortable_comming_to_clinic             VARCHAR(50),
    feels_not_conmfortable_coming_to_clinic_specify VARCHAR(255),
    medical_problem_report_symptoms           VARCHAR(50),
    feel_free_ask_hcw_questions               VARCHAR(50),
    feel_free_ask_hcw_reproductive_health     VARCHAR(50),
    name_different_contraception              VARCHAR(50),
    identify_one_person_to_seek_help          VARCHAR(50),
    attends_peer_support_group                VARCHAR(50),
    disclose_hiv_status_someone_else          VARCHAR(50),
    identify_treatment_buddy                  VARCHAR(50),
    varbalize_long_term_goals                 VARCHAR(50),
    ready_to_transition_adult_care            VARCHAR(50),
...
(
    ...
    provider                                  INT(11)  NOT NULL,
    visit_date                                DATE,   
    chilld_primary_caregiver                   VARCHAR(50),
    other_primary_caregiver                       VARCHAR(255),
    who_brought_child_clinic                      VARCHAR(50),
    ...
    disclosure_counseling_done                   VARCHAR(50),
    no_disclosure_counseling_done_why                    VARCHAR(50),
    content_of_disclosure_counseling              VARCHAR(255),
    other_why_no_disclosure_counseling_done                    VARCHAR(50),
    place_full_dislosure_occured                  VARCHAR(50),
    is_date_of_full_disclosure_known              VARCHAR(50),
    date_of_full_disclosure                       DATE,
    date_of_full_disclosure_not_known_specify     VARCHAR(255),
    who_conducted_full_disclosure                VARCHAR(50),
    other_who_conducted_full_disclosure           VARCHAR(255),
    nature_of_disclosure                          VARCHAR(50),
    child_reactions_dislosure                     VARCHAR(255),
    cadre                                         VARCHAR(100),
    department                                    VARCHAR(100),
    date_of_followup_visit                        DATE,
    caregiver_reflection_behaviour        VARCHAR(100),
    caregiver_reflection_mood             VARCHAR(100),
    caregiver_reflection_adherence        VARCHAR(100),
    caregiver_reflection_interaction_caregiver      VARCHAR(100),
    provider_reflection_behaviour         VARCHAR(100),
    provider_reflection_mood              VARCHAR(100),
    provider_reflection_adherence         VARCHAR(100),
    provider_reflection_interaction_caregiver       VARCHAR(100),
    provider_reflection_interaction_provider       VARCHAR(100),
...
CREATE TABLE kenyaemr_etl.etl_mat_intial_registrations
(
    uuid               CHAR(38) NOT NULL,
    ...
    encounter_id       INT(11)  NOT NULL PRIMARY KEY,
    client_type        INT(11),
    referral_type      INT(11),
    accompanied_by         INT(11),
    outreach_worker        INT(11),
    service_provider        INT(11),
...
CREATE TABLE kenyaemr_etl.etl_mat_clinical_encounter
(
    uuid               CHAR(38) NOT NULL,
    encounter_provider INT(11)  NOT NULL,
    patient_id         INT(11)  NOT NULL,
    ...
    hepatitis_B_treated        INT(11),
    hepatitis_C_screened        INT(11),
    hepatitis_C_treated        INT(11),
    is_suffering_mental_disorder         INT(11),
    treating_mental_disorder        INT(11),
    diagnosed_illnesses        INT(11),
    has_disease_type        INT(11),
...
CREATE TABLE kenyaemr_etl.etl_mat_transit
(
    uuid               CHAR(38) NOT NULL,
    encounter_provider INT(11)  NOT NULL,
    patient_id         INT(11)  NOT NULL,
...
CREATE TABLE kenyaemr_etl.etl_mat_psychosocial_intake_and_followup
(
    uuid               CHAR(38) NOT NULL,
    encounter_provider INT(11)  NOT NULL,
    patient_id         INT(11)  NOT NULL,
    ...
    encounter_id       INT(11)  NOT NULL PRIMARY KEY,
    experienced_gbv        INT(11),
    type_of_gbv_experienced        INT(11),
    treatment_stage        INT(11),
    received_violence_support        VARCHAR(255),
    reintegrated_back        INT(11),
    date_created       DATETIME NOT NULL,
    date_last_modified DATETIME,
    voided             INT(11),
    CONSTRAINT FOREIGN KEY (patient_id)
...
CREATE TABLE kenyaemr_etl.etl_mat_cessation
(
    uuid               CHAR(38) NOT NULL,
    encounter_provider INT(11)  NOT NULL,
    patient_id         INT(11)  NOT NULL,
    ...
    location_id        INT(11)  NOT NULL,
    encounter_id       INT(11)  NOT NULL PRIMARY KEY,
    on_methadone_for_past_12_months        INT(11),
    weaned_off_methadone        INT(11),
    date_created       DATETIME NOT NULL,
    date_last_modified DATETIME,
    voided             INT(11),
    CONSTRAINT FOREIGN KEY (patient_id)
